...
import { createGame, joinGame, move, updateBoard, getAllGames,leaveGame ,deleteGame,refreshPending} from '../controller/game.controller.js';
...
gameRouter.post("/refreshPending", refreshPending);
